...
public class LoadSaveText_TextMeshPro3D_JSON : MonoBehaviour, RTE.RuntimeTextEdit.TextEditCallback
{
  ...
  void Start()
  {
    ...
    this.gameObject.GetComponent<TMPro.TextMeshPro>().text = textObject.text;
  }
